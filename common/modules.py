...
from police.shootings import FatalShootings
from police.ethnicity import FatalShootingsRaceEthnicity
...
entity_map = {
    ...
    entity_key.police_race_ethnicity: FatalShootingsRaceEthnicity,
